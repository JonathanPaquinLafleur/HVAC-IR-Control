...
//#define  HVAC_MITSUBISHI_DEBUG;  // Un comment to access DEBUG information through Serial Interface
  ...
  byte data[18] = { 0x23, 0xCB, 0x26, 0x01, 0x00, 0x20, 0x38, 0x06, 0x30, 0x45, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1F };
  // data array is a valid trame, only byte to be chnaged will be updated.
  ...
  switch (HVAC_Mode)
  {
    case HVAC_HOT:   data[6] = (byte) 0x00; break;
    case HVAC_COLD:  data[6] = (byte) 0x18; break;
    case HVAC_DRY:   data[6] = (byte) 0x10; break;
    case HVAC_AUTO:  data[6] = (byte) 0x38; break;
    default: break;
  }
